...
@tyrannosaurus = Dinosaur.new(name: "Jacky", species: "tyrannosaurus", price: 1000, review: 5, availability_start: "28/02/2023",
  availability_end: "23/04/2023", user: @nicolas, weight: "6000", height: "4", element: "earth", age: 66,
...
@stegosaurus = Dinosaur.new(name: "Jean-Louis", species: "stegosaurus", price: 900, review: 4, availability_start: "03/03/2023",
  availability_end: "09/03/2023", user: @mong, weight: "5500", height: "4", element: "earth", age: 155,
...
@triceratops = Dinosaur.new(name: "Kévin", species: "triceratops", price: 800, review: 3, availability_start: "09/03/2023",
  availability_end: "17/03/2023", user: @malo, weight: "12000", height: "3", element: "earth", age: 67,
...
@velociraptor = Dinosaur.new(name: "Jérem", species: "velociraptor", price: 700, review: 3, availability_start: "14/03/2023",
  availability_end: "16/03/2023", user: @justine, weight: "18", height: "1", element: "earth", age: 71,
...
@diplodocus = Dinosaur.new(name: "Huguette", species: "diplodocus", price: 800, review: 5, availability_start: "28/03/2023",
  availability_end: "09/04/2023", user: @justine, weight: "16000", height: 25, element: "earth", age: 153,
...
@spinosaurus = Dinosaur.new(name: "Chantal", species: "spinosaurus", price: 600, review: 2, availability_start: "24/04/2023",
  availability_end: "29/04/2023", user: @justine, weight: "6000", height: "15", element: "earth", age: 97,
...
@brontosaurus = Dinosaur.new(name: "Marcellin", species: "brontosaurus", price: 800, review: 4, availability_start: "06/05/2023",
  availability_end: "20/05/2023", user: @justine, weight: "15000", height: "22", element: "earth", age: 155,
...
@ankylosaurus = Dinosaur.new(name: "Janine", species: "ankylosaurus", price: 400, review: 2, availability_start: "09/05/2023",
  availability_end: "20/05/2023", user: @justine, weight: "4000", height: "2", element: "earth", age: 66,
...
@archaeopteryx = Dinosaur.new(name: "Roberto", species: "archaeopteryx", price: 200, review: 1, availability_start: "18/05/2023",
  availability_end: "22/05/2023", user: @justine, weight: "1", height: "1", element: "air", age: 154,
...
@iguanodon = Dinosaur.new(name: "Léon", species: "iguanodon", price: 300, review: 4, availability_start: "07/05/2023",
  availability_end: "29/05/2023", user: @justine, weight: "4000", height: "5", element: "earth", age: 133,
